 ...
 * BSAPI types
 *
 * Copyright (C) 2007-2009 UPEK Inc.
 */
...
typedef struct abs_bir {
  ...
  ABS_BYTE Data[2560]; 	///< The data composing the fingerprint template.
} ABS_BIR;
...
#define ABS_FLAG_HIGH_RESOLUTION    0x8    ///< Requires to use higher sample image resolution.
 ...
 */
#define ABS_PKEY_WAIT_FOR_ACCEPTABLE    1    ///< Disables default one-attempt approach of ABSRawGrab.
...
typedef struct abs_image {
  ...
  ABS_BYTE ImageData[55555]; 	///< Color values of all pixels.
} ABS_IMAGE;
...
#define ABS_PARAM_CONSOLIDATION_COUNT    1    ///< Specifies count of finger swipes for consolidation. 
...
#define ABS_PARAM_POWER_SAVE_TIMEOUT    7    ///< Determines for how long time the user is considered to be active after touching sensor, or using keyboard or mouse.
