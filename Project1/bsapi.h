 ...
 * call any other function. It is called typically during application startup.
 * 
 * @param dwFlags On Windows only flag ABS_INIT_FLAG_NT_SERVICE is supported.
 ...
 * BSAPI library should be kept initialized until the program exits,
 ...
 * connection it should be closed with ABSClose.
 * @return Status code.
 */
 ...
 * @param pboIsLatent Pointer to ABS_BOOL, where the result of the check is stored.
 * It is set to ABS_TRUE, if the latest scanned finger was detected as a 
 ...
 * @param dwLED1 Returns a value defining the detailed behavior of the 1st LED. 
 * @param dwLED2 Returns a value defining the detailed behavior of the 2nd LED. 
 * @return Status code.
 */
